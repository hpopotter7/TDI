                                      ...
                                      //$('#c_numero_evento').val();
                                        ...
                                        $.ajax({
                                          ...
                                          success:  function (response) {
                                            ...
                                            if(response.includes("registro odc correcto")){
                                              var ev=$('#c_numero_evento').val()
                                              enviar_notificacion_llegando_limite(ev);
                                              generate('success',"La solicitud se ha guardado correctamente");
         ...
         $.ajax({
              ...
              success:  function (response) {
                if(response.includes("ya existe")){
                  ...
                  limpiar_cliente();
                  $('#txt_rfc').val('');
                  generate('warning', 'Este RFC esta bloqueado, para más información consultar a Sanayn Martinez');
                }
              }
            });
        }
