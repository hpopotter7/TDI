...
<meta charset="utf-8">
  ...
  <link href="https://fonts.googleapis.com/css?family=Nunito:400,600,700" rel="stylesheet">
    ...
    <link rel="stylesheet" href="css/estilos_fixed.css">
...
<div class="header">
    <h3>Evento: [2019-001] CLIENTE - NOMBRE DEL EVENTO</h3>
</div>
<div class="main">
    

<body class='normal' style='background-color: rgba(255,255,255,.3) !important;background:none !important;font-size:12px !important;overflow:auto'>
	<input type="hidden" id='txt_evento' value='
		<?php echo $evento;?>'>
		<div style="width:100% !important;;margin: auto;">
			...
			<div class="row">
				...
				<div class="form-group col-md-3" style='margin-top:32px'>
					<div class="btn-group">
						...
						<div class="dropdown-menu">
							<button type='button' class="dropdown-item class" id='btn_sin_factura'>
								<i style='color:#e2a03f' class="fas fa-exclamation-circle"></i> Eventos pendientes
							</button>
							<button type='button' class="dropdown-item" id='btn_transferir'>
								<i style='color:#1b55e2' class="fas fa-exchange-alt"></i> Transferir
							</button>
							<button type='button' class="dropdown-item" id='btn_borrar_sdp'>
								<i style='color:#e7515a' class="fas fa-trash"></i> Borrar
							</button>
							<!-- <button type='button' class="dropdown-item" id='btn_zoom'><i style='color:#a045f3' class="fas fa-search-plus"></i> Ajustar zoom</button> -->
							<small id="helpId" class="text-muted">Ajustar zoom 
								<output id='range_valor'> 100%</output>
							</small>
				...
				<div class="row">
					...
					<!--  </section> -->
					<div class="row normal" id='resultado_solicitudes' style='background-color:rgba(255,255,255,.3);width:96%;'></div>
					<!-- <div class="row" id='espacio' ><canvas id="myChart" height="75" width="75"></canvas><span></span></div> -->
				</div>
				<!-- <div id="modal_demo" class="modal"><div contenteditable="true" id='mensaje_demo'></div></div> -->
				<div id="modal_demo" class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<div class="modal-body" id='mensaje_demo'></div>
						</div>
					</div>
				</div>
            </div>
