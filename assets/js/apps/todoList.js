...
function checkCheckbox() {
  ...
  $('.todo-item input[type="checkbox"]').click(function() {
    ...
    modificar_estatus(estatus, id_notificacion);
    new dynamicBadgeNotification('completedList');
    new dynamicBadgeNotification('allList');
    new dynamicBadgeNotification('importantList');
  });
  ...
  $.ajax({
    ...
    success:  function (response) {
       if(response.includes("ninguno")){
        parent.$('.span_notificacion').hide();                     
      }
      else{
        parent.$('.span_notificacion').show(); 
        parent.$(".span_notificacion").css("display", "inline");
      }
...
function modificar_estatus(estatus, id_notificacion){
  var parametros={
    "estatus": estatus,
    "id_notificacion": id_notificacion
  }
   $.ajax({
      url:   "modificar_estatus_notificacion.php",
      type:  'post',
      data: parametros,
      success:  function (response) {
