...
<body style='background-color: rgba(0,0,0,.0) !important;'>              
        <div id="content" class="main-content" style="width: 100% !important; margin: auto !important;background-color: rgba(0,0,0,.0) !important;">
                            ...
                            <div class="tab-title">
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 col-12 text-center">  
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#0066FF" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-message-square"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"></path></svg>
                                        <h5 class="app-title">Mensajes</h5>
                                    </div>
                                        ...
                                        if ($result = $mysqli->query($sql)) {
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                <label class="new-control new-checkbox checkbox-primary">
                                                    <input value="'.$id_notificacion.'" type="checkbox" class="new-control-input inbox-chkbox" '.$atendido.'>
                                            ...
                                            <p class="todo-text" data-todoHtml="'.$mensaje.'">'.$de.'</p>
                                                </div>
                                                </div>
                                            </div>';
                                            }
