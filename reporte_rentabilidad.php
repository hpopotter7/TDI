   ...
   $cont=0;
    while ($row = $result->fetch_assoc()) {
        ...
        if($comodin_cliente!=$cliente){
            ...
            $tabla=$tabla."<td class='oculto' ><textarea class='oculto ".$clase."'>".$tabla_interna."</textarea></td>";
            $tabla=$tabla."</tr>";
            ...
            $tabla_interna=$tabla_interna."<td class='oculto'>detalle</td>";
