...
$.noty.themes.defaultTheme = {
  ...
  style   : function () {
    ...
    switch (this.options.type) {
      case 'alert':
      case 'notification':
        this.$bar.css({backgroundColor: '#FCF281', borderColor: '#CCC', color: '#000'});
        break;
      case 'warning':
...
$.noty.themes.metroui = {
  ...
  style   : function () {
    ...
    switch (this.options.type) {
      case 'alert':
      case 'notification':
        this.$bar.css({backgroundColor: '#FCF281', border: 'none', color: '#000'});
        break;
      case 'warning':
        this.$bar.css({backgroundColor: '#AE5E9B', border: 'none', color: '#fff'});
        this.$buttons.css({borderTop: '1px solid #AE5E9B'});
        break;
      case 'error':
...
$.noty.themes.relax = {
  ...
  style   : function () {
    ...
    switch (this.options.type) {
      case 'alert':
      case 'notification':
        this.$bar.css({backgroundColor: '#FCF281', borderColor: '#dedede', color: '#000'});
        break;
      case 'warning':
        this.$bar.css({backgroundColor: '#FFEAA8', borderColor: '#FFC237', color: '#826200'});
        this.$buttons.css({borderTop: '1px solid #FFC237'});
