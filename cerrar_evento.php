...
div { 
 ...
 <script src="js/metodos_cerrar.js"></script>
  <script>
...
<div class="row">
	<div class="col-md-6 col-sm-6">
		<select name="c_eventos" id="c_eventos" class="form-control">
		</select>
	</div>
</div>
...
<div class="row">
	<div class="col-md-3 col-sm-3">
		<button id='cerrar_evento' type="button" class="btn btn-success">Cerrar evento</button>
	</div>
</div>
